...
public class formularioDTO {
    ...
    // OpcionesMes, OpcionesSexo, OpcionesCivil, and OpcionesLaboral are assumed to be enum types.
    ...
    @NotBlank(message = "El estado civil no puede estar en blanco")
    private String est_civil;

    private OpcionesCivil[] opcionesCivil;

    @NotBlank(message = "La situación laboral no puede estar en blanco")
